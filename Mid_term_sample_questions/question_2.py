...
def f(n):
    ...
    n_string_list = list(str(n_factorial))
    nb_of_threes = n_string_list.count('3')
    print(f'{n}! is {n_factorial}')
    if nb_of_threes == 0:
        print('There is no 3 in', n_factorial)
    elif nb_of_threes == 1:
        print('There is one 3 in', n_factorial)
    else:
        print('There are', nb_of_threes, "3's in", n_factorial)
